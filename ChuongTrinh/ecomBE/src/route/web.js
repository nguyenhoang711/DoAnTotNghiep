...
let initwebRoutes = (app) => {
    ...
    //===================API USERV2========================//
    router.post('/api/create-new-userv2', uploadDisk.single('file'), asyncHandler(userControllerV2.handleCreateNewUser))
    router.get('/api/get-detail-userv2-by-id', asyncHandler(userControllerV2.handleGetUserDetailsById))
    router.put('/api/update-userv2', uploadDisk.single('file'), asyncHandler(userControllerV2.handleUpdateUserData))
    router.post('/api/login-v2', asyncHandler(userControllerV2.handleLogin))
    ...
    ///=================API UPLOAD IMAGE================================//
    router.post('/api/upload-user-avatar-from-url', asyncHandler(uploadController.uploadFile))
    router.post('/api/upload-user-image-from-local', uploadDisk.single('file'), asyncHandler(uploadController.uploadFileThumb))
    router.post('/api/upload-user-from-local-files', uploadDisk.array('files', 3), asyncHandler(uploadController.uploadImageFromLocalFiles))
