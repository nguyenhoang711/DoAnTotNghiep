...
function HomePage(props) {
    ...
    return (
        <div>
            ...
            <NewProductFeature title="Sản phẩm mới" description="Những sản phẩm vừa ra mắt với những mẫu mã mới hợp trend" data={dataNewProductFeature}></NewProductFeature>
